              ...
              child: Center(
                child: Column(
                  ...
                  Container(
                    ...
                    CircleAvatar(
                      ...
                      child: Image.asset('photos/man.png',),
                      radius: 50,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Text('Rosina Doe',style: TextStyle(fontSize: 28,color: Colors.white),),
                          SizedBox(height: 20,),
                          Row(
                            ...
                            children: [
                             Icon(Icons.location_on_outlined,color: Colors.white,size: 35,),
                              ...
                              Text('Address 43 , Uk',style: TextStyle(color: Colors.white,fontSize: 20),),
                            ],
                          ),
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                    Text('Shopping Address',style: TextStyle(color: Colors.white,
                        fontSize: 23
                    ),),
                    ...
                    Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('order History',style: TextStyle(color: Colors.white,
                                fontSize: 23
                            ),),
                            Icon(Icons.chevron_right_sharp,color: Colors.white,size: 30,),
                          ],)
